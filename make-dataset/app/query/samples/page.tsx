...
const SamplePage = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      {isLoading ? <div className="w-full h-full flex flex-col justify-center items-center min-h-[400px] text-2xl">Loading Samples...</div> : <div className="grid md:grid-cols-2 xl:grid-cols-3 w-full gap-4 px-4 pb-6">
